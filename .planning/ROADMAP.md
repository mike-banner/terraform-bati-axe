...
- [ ] **Phase 05.15: FIX Verrouillage Leads non-vérifiés** - Blocage strict du déblocage des leads sur `/espace/leads` si `decennal_status !== 'verified'` + bannière d'alerte et bouton vers l'envoi des justificatifs.
