...
<template>
  <span class="premium-badge inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full border border-primary/30 text-foreground bg-page">
    <svg class="w-3.5 h-3.5 text-safety shrink-0" fill="currentColor" viewBox="0 0 20 20">
...
.premium-badge:hover {
  box-shadow: 0 8px 20px -6px var(--color-primary, rgba(100, 116, 139, 0.35));
